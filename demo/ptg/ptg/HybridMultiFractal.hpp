...
#include "Continuous2DSignal.hpp"
...
public:
	...
	HybridMultiFractal(const HybridMultiFractal&); //copies will share the same base noise, this means that seeding one, will seed both.
	HybridMultiFractal & operator=(const HybridMultiFractal&);
private:
	void initExponents();
